...
class calon_siswa extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/ppdb/page/calon_siswa/index_page/index','role/ppdb/page/calon_siswa/index_page/js'],$data);
	}
	public function mutasi()
	{
		...
		$this->my_view(['role/ppdb/page/calon_siswa/mutasi/index','role/ppdb/page/calon_siswa/mutasi/js'],$data);
	}
	public function kenaikan()
	{
		...
		$data['kelas']		=	$this->my_where('kelas', [])->result_array();
		$this->my_view(['role/ppdb/page/calon_siswa/kenaikan/index','role/ppdb/page/calon_siswa/kenaikan/js'],$data);
	}
	...
	public function kelulusan()
	{
		...
		$data['jurusan']		=	$this->my_where('jurusan', [])->result_array();
		$data['kelas']		=	$this->my_where('kelas', [])->result_array();
		$this->my_view(['role/ppdb/page/calon_siswa/kelulusan/index','role/ppdb/page/calon_siswa/kelulusan/js'],$data);
	}
	...
	public function import_page()
	{
		...
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/ppdb/page/calon_siswa/import_page/index','role/ppdb/page/calon_siswa/import_page/js'],$data);
	}
	public function add_page($no_reg="")
	{
		...
		$this->my_view(['role/ppdb/page/calon_siswa/add_page/index','role/ppdb/page/calon_siswa/add_page/js'],$data);
	}
	public function perkelas()
	{
		...
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/ppdb/page/calon_siswa/perkelas/index','role/ppdb/page/calon_siswa/perkelas/js'],$data);
	}
	...
	*/
	...
	public function import_calon_siswa($value='')
	{
		...
		if(isset($_FILES['file_upload']['name']) && in_array($_FILES['file_upload']['type'], $file_mimes)) {
			...
			$this->my_view(['role/ppdb/page/calon_siswa/import_page/proses_import'],$data);
		}
		// print_r($_FILES);
	}
	...
	function get_calon_siswa_mutasi()
	{
		...
		$this->my_view(['role/ppdb/page/calon_siswa/mutasi/get_calon_siswa'],$data);		
	}
	function get_calon_siswa_kelulusan()
	{
		...
		$data['calon_siswa']		=	$this->my_where('calon_siswa', ['idkelas_fk'=>$_POST['idkelas']])->result_array();
		$data['kelas']		=	$this->my_where('kelas', ['id_kelas'=>$_POST['idkelas']])->row_array();
		$this->my_view(['role/ppdb/page/calon_siswa/kelulusan/get_calon_siswa'],$data);		
	}
	...
	function get_kelas_tujuan_mutasi()
	{
		...
		$data['kelas']		=	$this->my_where('kelas', ['id_kelas'=>$_POST['idkelas']])->row_array();
		$data['calon_siswa']		=	$this->my_where('calon_siswa', ['idkelas_fk'=>$_POST['idkelas']])->result_array();
		$this->my_view(['role/ppdb/page/calon_siswa/mutasi/get_kelas_tujuan'],$data);	
	}
