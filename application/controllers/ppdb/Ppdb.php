...
class Ppdb extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/ppdb/page/ppdb/index_page/index','role/ppdb/page/ppdb/index_page/js'],$data);
	}
	...
	public function list()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/ppdb/page/ppdb/index_page/index_list','role/ppdb/page/ppdb/index_page/js_list'],$data);
	}
	...
	function detail_data($id = "")
	{
		if ($id !== "") {
			...
			$this->my_view(['role/ppdb/page/ppdb/detail_page/index','role/ppdb/page/ppdb/detail_page/js'],$data);
		}
	}
	...
	*/
		...
		function cetak_page()
		{
			...
			// $this->my_view(['role/ppdb/page/guru/print_page/index','role/ppdb/page/guru/print_page/js'],$data);
		...
		function cetak_data()
		{
			...
			$url	=	($_POST['laporan']	==	'data')	?	'role/core_page/print_page/cetak_data'	:	'role/core_page/print_page/cetak_karppdb';
	...
	*/
	...
	public function datatable()
	{
        ...
        foreach ($list as $field) {
            ...
            $row[]		=	($field['stappdbs'] == 0) ? "<b class='text-danger'><i class='icon-cross2'></i></b>" : '<b class="text-success"><i class="icon-checkmark"></i></b>';
            $row[]		=	($field['stappdbs'] == 0) ? '<a href="Ppdb/detail_data/'.$field['id_ppdb'].'" class="btn btn-danger app-item"><i class="icon-spinner"></i> Verifikasi</a>' : '<a class="btn btn-succes app-item"><i class="icon-spinner"></i> Ubah Stappdbs</a>';
            $data[]     =   $row;
        }
        $output = array(
            "draw" => $_POST['draw'],
