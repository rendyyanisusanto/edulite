...
class alumni extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/BK/page/alumni/index_page/index','role/BK/page/alumni/index_page/js'],$data);
	}
	...
	public function persebaran_alumni()
	{
		...
		$this->my_view(['role/BK/page/alumni/persebaran_page/index','role/BK/page/alumni/persebaran_page/js'],$data);
	}
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/BK/page/alumni/add_page/index','role/BK/page/alumni/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/BK/page/alumni/edit_page/index','role/BK/page/alumni/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/BK/page/alumni/print/print_surat',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/BK/page/alumni/print_page/index','role/BK/page/alumni/print_page/js'],$data);
