...
class Coa extends MY_Controller {
	public function get_data()
	{
		...
		$this->my_view(['role/bendahara/page/coa/index_page/index','role/bendahara/page/coa/index_page/js'],$data);
	}
	function get_akun($id = "")
	{
		...
		$this->my_view(['role/bendahara/page/coa/index_page/proses_akun'],$data);
	}
