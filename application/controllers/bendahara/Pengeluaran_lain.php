...
class pengeluaran_lain extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/bendahara/page/pengeluaran_lain/index_page/index','role/bendahara/page/pengeluaran_lain/index_page/detail_pengeluaran','role/bendahara/page/pengeluaran_lain/index_page/js'],$data);
	...
	public function add_page()
	{
		...
		$this->my_view(['role/bendahara/page/pengeluaran_lain/add_page/index','role/bendahara/page/pengeluaran_lain/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/bendahara/page/pengeluaran_lain/edit_page/index','role/bendahara/page/pengeluaran_lain/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
