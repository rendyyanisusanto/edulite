...
class penggajian extends MY_Controller {
	...
	public $arr = [
			...
			'id'				=>	'id_penggajian',
			'parents_link'		=>	'role/bendahara/page/penggajian'
	];
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/bendahara/page/penggajian/index_page/index','role/bendahara/page/penggajian/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/bendahara/page/penggajian/add_page/index','role/bendahara/page/penggajian/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$data['tahun_ajaran']		=	$this->my_where('tahun_ajaran', [])->result_array();
				$this->my_view(['role/bendahara/page/penggajian/edit_page/index','role/bendahara/page/penggajian/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	function print_nota($id='', $bulan='', $tahun = '')
	{
		...
		$data['bulan']	=	$bulan;
		$data['tahun']	=	$tahun;
		$this->load->view('role/bendahara/page/penggajian/print/index', $data);
	}
	/*
		ADD DATA
	*/
	...
	*/
	...
	public function print_kartu($id='')
	{
		...
		$this->my_view(['role/bendahara/page/penggajian/print_page/cetak_kartu_kendali'],$data);
	}
