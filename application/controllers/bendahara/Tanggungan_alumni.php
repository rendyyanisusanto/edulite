...
class Tanggungan_alumni extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/bendahara/page/tanggungan_alumni/index_page/index','role/bendahara/page/tanggungan_alumni/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/bendahara/page/tanggungan_alumni/add_page/index','role/bendahara/page/tanggungan_alumni/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/bendahara/page/alumni/edit_page/index','role/bendahara/page/alumni/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/bendahara/page/alumni/print/print_surat',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/bendahara/page/alumni/print_page/index','role/bendahara/page/alumni/print_page/js'],$data);
	...
	*/
	...
	function content_panel(){
		...
		$this->my_view(['role/bendahara/page/tanggungan_alumni/index_page/content_panel', 'role/bendahara/page/tanggungan_alumni/index_page/content_panel_alumni', 'role/bendahara/page/tanggungan_alumni/index_page/modal'],$data);
