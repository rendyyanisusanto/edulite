...
class jenis_kerjasama extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/humas/page/jenis_kerjasama/index_page/index','role/humas/page/jenis_kerjasama/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/humas/page/jenis_kerjasama/add_page/index','role/humas/page/jenis_kerjasama/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/humas/page/jenis_kerjasama/edit_page/index','role/humas/page/jenis_kerjasama/edit_page/js'],$data);
		} else {
			// $this->get_data();
		}
	}
