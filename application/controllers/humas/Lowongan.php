...
class lowongan extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/humas/page/lowongan/index_page/index','role/humas/page/lowongan/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/humas/page/lowongan/add_page/index','role/humas/page/lowongan/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$data['dudi']		=	$this->my_where('dudi',[])->result_array();
				$this->my_view(['role/humas/page/lowongan/edit_page/index','role/humas/page/lowongan/edit_page/js'],$data);
		} else {
			// $this->get_data();
		}
	}
