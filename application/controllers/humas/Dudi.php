...
class dudi extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/humas/page/dudi/index_page/index','role/humas/page/dudi/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/humas/page/dudi/add_page/index','role/humas/page/dudi/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/humas/page/dudi/edit_page/index','role/humas/page/dudi/edit_page/js'],$data);
		} else {
			// $this->get_data();
		}
	}
