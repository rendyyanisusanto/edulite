...
class kerjasama_dudi extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/humas/page/kerjasama_dudi/index_page/index','role/humas/page/kerjasama_dudi/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/humas/page/kerjasama_dudi/add_page/index','role/humas/page/kerjasama_dudi/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$data['dudi']		=	$this->my_where('dudi',[])->result_array();
				$data['jenis_kerjasama']		=	$this->my_where('jenis_kerjasama',[])->result_array();
				$this->my_view(['role/humas/page/kerjasama_dudi/edit_page/index','role/humas/page/kerjasama_dudi/edit_page/js'],$data);
		} else {
			// $this->get_data();
		}
	}
