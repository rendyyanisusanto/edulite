...
class sosialisasi extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/admin/page/sosialisasi/index_page/index','role/admin/page/sosialisasi/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/admin/page/sosialisasi/add_page/index','role/admin/page/sosialisasi/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/admin/page/sosialisasi/edit_page/index','role/admin/page/sosialisasi/edit_page/js'],$data);
		} else {
			// $this->get_data();
		}
	}
