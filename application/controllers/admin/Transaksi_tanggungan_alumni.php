...
class transaksi_tanggungan_alumni extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/transaksi_tanggungan_alumni/index_page/index','role/admin/page/transaksi_tanggungan_alumni/index_page/js'],$data);
	...
	public function add_page()
	{
		...
		$this->my_view(['role/admin/page/transaksi_tanggungan_alumni/add_page/index','role/admin/page/transaksi_tanggungan_alumni/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/admin/page/transaksi_tanggungan_alumni/edit_page/index','role/admin/page/transaksi_tanggungan_alumni/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
	...
	function add_row(){
		...
		$this->my_view(['role/admin/page/transaksi_tanggungan_alumni/add_page/row'],$data);
	}
