...
class pelanggaran_siswa extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/pelanggaran_siswa/index_page/index','role/admin/page/pelanggaran_siswa/index_page/js'],$data);
	}
	...
	public function poin_pelanggaran_setup()
	{
		...
		$this->my_view(['role/admin/page/pelanggaran_siswa/index_page/poin_pelanggaran_setup','role/admin/page/pelanggaran_siswa/index_page/js_poin_pelanggaran_setup'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/pelanggaran_siswa/add_page/index','role/admin/page/pelanggaran_siswa/add_page/js'],$data);
	}
	...
	public function cetak_kartu()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/pelanggaran_siswa/print_page/cetak_kartu','role/admin/page/pelanggaran_siswa/print_page/js_kartu'],$data);
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/admin/page/pelanggaran_siswa/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/admin/page/pelanggaran_siswa/print_page/index','role/admin/page/pelanggaran_siswa/print_page/js'],$data);
	...
	*/
	...
	public function print_kartu($id='')
	{
		...
		$this->my_view(['role/admin/page/pelanggaran_siswa/print_page/cetak_kartu_kendali'],$data);
	}
