...
class inventaris extends MY_Controller {
	...
	*/
	...
	public function add_page()
	{
		...
		$this->my_view(['role/admin/page/inventaris/add_page/index','role/admin/page/inventaris/add_page/js'],$data);
	}
	...
	public function edit_page()
	{
		...
		$data['tahun_ajaran']	=	$this->my_where('tahun_ajaran',[])->result_array();
		$data['jenis_barang']	=	$this->my_where('jenis_barang',[])->result_array();
		$this->my_view(['role/admin/page/inventaris/edit_page/index','role/admin/page/inventaris/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
