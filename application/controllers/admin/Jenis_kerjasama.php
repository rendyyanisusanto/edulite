...
class jenis_kerjasama extends MY_Controller {
	

	public $arr = [
			'title'				=>	'Halaman jenis_kerjasama',
			'table'				=>	'jenis_kerjasama',
			'column'			=>	[ 'jenis_kerjasama'],
			'column_order'		=>	[ 'id_jenis_kerjasama','jenis_kerjasama'],
			'column_search'		=>	[ 'id_jenis_kerjasama','jenis_kerjasama'],
			'order'				=>	['id_jenis_kerjasama'	=>	'DESC'],
			'id'				=>	'id_jenis_kerjasama'
	];
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/admin/page/jenis_kerjasama/index_page/index','role/admin/page/jenis_kerjasama/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/admin/page/jenis_kerjasama/add_page/index','role/admin/page/jenis_kerjasama/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				$data['param'] 		= 	$this->arr;
				$data['jenis_kerjasama'] = 	$this->my_where('jenis_kerjasama',['id_jenis_kerjasama'=>$id])->row_array();
				$this->my_view(['role/admin/page/jenis_kerjasama/edit_page/index','role/admin/page/jenis_kerjasama/edit_page/js'],$data);
		} else {
			// $this->get_data();
		}
	}
	...
	*/
	...
	{	
		...
		if ($this->save_data('jenis_kerjasama', $data)) {
			echo "Success";
		}
	}
	...
	*/
	...
	function update_data()
	{
		...
		if ($this->my_update('jenis_kerjasama',$data,['id_jenis_kerjasama'=>$_POST['id_jenis_kerjasama']])) {
	...
	*/
	...
	public function datatable()
	{
        ...
        foreach ($list as $field) {
            ...
            $row        =   array();
            $row[]      =   '<input type="checkbox" name="get-check" value="'.$field['id_jenis_kerjasama'].'"></input>';
            $row[]		=	'<b>'.$field['jenis_kerjasama'].'</b>';
            $data[]     =   $row;
        }
        $output = array(
            "draw" => $_POST['draw'],
