...
class kondisi_prasarana extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/kondisi_prasarana/index_page/index','role/admin/page/kondisi_prasarana/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/kondisi_prasarana/add_page/index','role/admin/page/kondisi_prasarana/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/admin/page/kondisi_prasarana/edit_page/index','role/admin/page/kondisi_prasarana/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/admin/page/kondisi_prasarana/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/admin/page/kondisi_prasarana/print_page/index','role/admin/page/kondisi_prasarana/print_page/js'],$data);
