...
class dudi extends MY_Controller {
	

	public $arr = [
			'title'				=>	'Halaman dudi',
			'table'				=>	'dudi',
			'column'			=>	[ 'nama','no_hp','alamat'],
			'column_order'		=>	[ 'id_dudi','nama','no_hp','alamat'],
			'column_search'		=>	[ 'id_dudi','nama','no_hp','alamat'],
			'order'				=>	['id_dudi'	=>	'DESC'],
			'id'				=>	'id_dudi'
	];
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/admin/page/dudi/index_page/index','role/admin/page/dudi/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/admin/page/dudi/add_page/index','role/admin/page/dudi/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				$data['param'] 		= 	$this->arr;
				$data['dudi'] = 	$this->my_where('dudi',['id_dudi'=>$id])->row_array();
				$this->my_view(['role/admin/page/dudi/edit_page/index','role/admin/page/dudi/edit_page/js'],$data);
		} else {
			// $this->get_data();
		}
	}
	...
	*/
	...
	function update_data()
	{
		...
		if ($this->my_update('dudi',$data,['id_dudi'=>$_POST['id_dudi']])) {
