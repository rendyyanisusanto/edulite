...
class ijin_siswa extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/ijin_siswa/index_page/index','role/admin/page/ijin_siswa/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/admin/page/ijin_siswa/add_page/index','role/admin/page/ijin_siswa/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/admin/page/ijin_siswa/edit_page/index','role/admin/page/ijin_siswa/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/admin/page/ijin_siswa/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
	...
	*/
	...
	public function datatable()
	{
       $_POST['frm']   =   $this->arr;
        ...
        foreach ($list as $field) {
            ...
            $row[]		=	'<a class="btn btn-xs btn-primary" href="'.base_url('admin/ijin_siswa/print_data/'.$field['id_ijin_siswa']).'" target="__blank"><i class=" icon-printer"></i></a>';
	...
	function get_stats_nav()
	{
		...
		$this->my_view(['role/admin/page/ijin_siswa/index_page/stats'],$data);
	}
	function print_data($id)
	{
		...
		$this->load->view('role/admin/page/ijin_siswa/print/print_data',$data);
	}
