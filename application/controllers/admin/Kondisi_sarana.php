...
class kondisi_sarana extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/kondisi_sarana/index_page/index','role/admin/page/kondisi_sarana/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/admin/page/kondisi_sarana/add_page/index','role/admin/page/kondisi_sarana/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/admin/page/kondisi_sarana/edit_page/index','role/admin/page/kondisi_sarana/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/admin/page/kondisi_sarana/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/admin/page/kondisi_sarana/print_page/index','role/admin/page/kondisi_sarana/print_page/js'],$data);
