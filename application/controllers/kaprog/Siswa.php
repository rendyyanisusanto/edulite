...
class siswa extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		foreach ($data['kaprog'] as $key => $value) {
			...
			$data['detail_kaprog'][]	=	[
				...
				'kelas'			=>	$this->my_where('kelas', ['idjurusan_fk'=>$value['idjurusan_fk'], 'idtahunajaran_fk'=>$data['tahun_ajaran']['id_tahun_ajaran']])->result_array()
			];
		}
		$this->my_view(['role/kaprog/page/siswa/perkelas/index','role/kaprog/page/siswa/perkelas/js'],$data);
	...
	public function add_page()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/kaprog/page/siswa/add_page/index','role/kaprog/page/siswa/add_page/js'],$data);
	}

	public function upload_page()
	{
		$data['account']	=	$this->get_user_account();
		$this->my_view(['role/kaprog/page/siswa/upload_page','role/kaprog/page/siswa/js_upload_page'],$data);
	}
	/*
		ADD DATA
	*/
	...
	*/
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$data['jurusan']	=	$this->my_where('jurusan', [])->result_array();
				$data['province']	=	$this->my_where('provinces', [])->result_array();
				$this->my_view(['role/kaprog/page/siswa/edit_page/index','role/kaprog/page/siswa/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	function cetak_page($id)
		{
			if (isset($id)) {
				...
				$this->load->view('role/kaprog/page/siswa/print/print',$data);
			} else {
				$this->get_data();
			}
		}
	...
	*/
	...
	public function detail_all($id)
	{
		if (isset($id)) {
				...
				$data['province']	=	$this->my_where('provinces', ['id' => $data['siswa']['idprovince_fk']])->row_array();
				$data['city']		=	$this->my_where('cities', ['id' => $data['siswa']['idcities_fk']])->row_array();
				$this->my_view(['role/kaprog/page/siswa/detail_page/index','role/kaprog/page/siswa/detail_page/js'],$data);
		} else {
			$this->get_data();
		}
	...
	public function proses_siswa($value='')
	{
		...
		$this->my_view(['role/kaprog/page/siswa/perkelas/proses_siswa','role/kaprog/page/siswa/perkelas/js_proses'],$data);
	}
