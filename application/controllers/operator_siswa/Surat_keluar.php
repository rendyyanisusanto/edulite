...
class surat_keluar extends MY_Controller {
	...
	*/
	...
	public function add_page()
	{
		...
		$this->my_view(['role/operator_siswa/page/surat_keluar/add_page/index','role/operator_siswa/page/surat_keluar/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/operator_siswa/page/surat_keluar/edit_page/index','role/operator_siswa/page/surat_keluar/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/operator_siswa/page/surat_keluar/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/operator_siswa/page/surat_keluar/print_page/index','role/operator_siswa/page/surat_keluar/print_page/js'],$data);
	...
	*/
	...
	{
		$this->db->where('idkategorisuratkeluar_fk', 999);
        ...
        foreach ($list as $field) {
            ...
            $row[]		=	!empty($field['tanggal_deadline']) ? date_format(date_create($field['tanggal_deadline']),'d-m-Y') : '-';
	...
	function get_stats_nav()
	{
		...
		$this->my_view(['role/operator_siswa/page/surat_keluar/index_page/stats'],$data);
	}
}