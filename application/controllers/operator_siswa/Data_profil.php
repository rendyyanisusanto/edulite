...
class Data_profil extends MY_Controller {
	...
	{
		$data				=	$this->get_guru();
		$this->my_view(['role/operator_siswa/page/data_profil/index_page/index','role/operator_siswa/page/data_profil/index_page/js'],$data);
	}
	public function akun()
	{
		$data				=	$this->get_guru();
		$this->my_view(['role/operator_siswa/page/data_profil/index_page/akun','role/operator_siswa/page/data_profil/index_page/jsakun'],$data);
	}
	...
	function update_data()
	{
		...
		if ($this->my_update('operator_siswa', $data, ['id_operator_siswa'=>$_POST['id_operator_siswa']])) {
			$this->get_data();
		}	else 	{
			echo "error";
		}
