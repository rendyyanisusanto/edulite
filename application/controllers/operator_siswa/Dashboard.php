...
class Dashboard extends MY_Controller {
	public function get_data()
	{
		...
		if ($this->agent->is_mobile()) {
 			$this->my_view(['role/operator_siswa/page_mobile/dashboard/index_page/index','role/operator_siswa/page_mobile/dashboard/index_page/js'],$data);
 		}else{
 			$this->my_view(['role/operator_siswa/page/dashboard/index_page/index','role/operator_siswa/page/dashboard/index_page/js'],$data);
 		}
	}
