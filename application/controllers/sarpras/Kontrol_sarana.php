...
class kontrol_sarana extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/sarpras/page/kontrol_sarana/index_page/index','role/sarpras/page/kontrol_sarana/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/sarpras/page/kontrol_sarana/add_page/index','role/sarpras/page/kontrol_sarana/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/sarpras/page/kontrol_sarana/edit_page/index','role/sarpras/page/kontrol_sarana/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/sarpras/page/kontrol_sarana/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/sarpras/page/kontrol_sarana/print_page/index','role/sarpras/page/kontrol_sarana/print_page/js'],$data);
	...
	*/
	...
	function create_invoice($id){
		$param	=	[
	                'url'			=>	'role/sarpras/page/kontrol_sarana/print_page/invoice',
	                'customPaper'	=>	array(0,0,381.89,595.28),
	                'data_value'	=>	[
	                	"data"		=>	[],
	                	"param"		=>	[]
	...
	function add_row(){
		...
		$this->my_view(['role/sarpras/page/kontrol_sarana/add_page/row'],$data);
	}
	...
	function add_row_all(){
		...
		$this->my_view(['role/sarpras/page/kontrol_sarana/add_page/row_all'],$data);
	}
	...
	function get_detail($id)
	{
		...
		$this->my_view(['role/sarpras/page/kontrol_sarana/index_page/detail'],$data);
	}
	function get_stats_nav()
	{
		...
		$this->my_view(['role/sarpras/page/kontrol_sarana/index_page/stats'],$data);
	}
