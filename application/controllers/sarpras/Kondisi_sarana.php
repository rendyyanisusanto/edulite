...
class kondisi_sarana extends MY_Controller {
	

	public $arr = [
			'title'				=>	'Halaman kondisi_sarana',
			'table'				=>	'kondisi_sarana',
			'column'			=>	['kondisi_sarana'],
			'column_order'		=>	[ 'id_kondisi_sarana','kondisi_sarana','warna'],
			'column_search'		=>	[ 'id_kondisi_sarana','kondisi_sarana','warna'],
			'order'				=>	['id_kondisi_sarana'	=>	'DESC'],
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/sarpras/page/kondisi_sarana/index_page/index','role/sarpras/page/kondisi_sarana/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/sarpras/page/kondisi_sarana/add_page/index','role/sarpras/page/kondisi_sarana/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				$data['param'] 		= 	$this->arr;
				$data['kondisi_sarana'] = 	$this->my_where('kondisi_sarana',['id_kondisi_sarana'=>$id])->row_array();
				$this->my_view(['role/sarpras/page/kondisi_sarana/edit_page/index','role/sarpras/page/kondisi_sarana/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
	...
	{	
		...
		$data = [
			'kondisi_sarana' 	=> $_POST['kondisi_sarana'],
			'warna' 			=> $_POST['warna'],
		];

		if ($this->save_data('kondisi_sarana', $data)) {
			echo "Success";
		}
	}
	...
	*/
	...
	function update_data()
	{
		...
		if ($this->my_update('kondisi_sarana',$data,['id_kondisi_sarana'=>$_POST['id_kondisi_sarana']])) {
	...
	*/
		...
		{
				$data['param'] 		= 	$this->arr;
				$data['kondisi_sarana'] 	= $this->db->query('SELECT * FROM `kondisi_sarana` where date(tanggal_surat) = DATE(NOW())')->result_array();
				$this->load->view('role/sarpras/page/kondisi_sarana/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/sarpras/page/kondisi_sarana/print_page/index','role/sarpras/page/kondisi_sarana/print_page/js'],$data);
