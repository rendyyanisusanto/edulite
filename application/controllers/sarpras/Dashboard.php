...
class Dashboard extends MY_Controller {
	public function get_data()
	{
		...
		$this->my_view(['role/sarpras/page/dashboard/index_page/index','role/sarpras/page/dashboard/index_page/js'],$data);
	}
	public function stats()
	{
		...
		$this->my_view(['role/sarpras/page/dashboard/index_page/stats'],$data);
