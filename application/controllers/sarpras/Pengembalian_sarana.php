...
class pengembalian_sarana extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/sarpras/page/pengembalian_sarana/index_page/index','role/sarpras/page/pengembalian_sarana/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/sarpras/page/pengembalian_sarana/add_page/index','role/sarpras/page/pengembalian_sarana/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/sarpras/page/pengembalian_sarana/edit_page/index','role/sarpras/page/pengembalian_sarana/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
	...
	function create_invoice($id){
		$param	=	[
	                'url'			=>	'role/sarpras/page/pengembalian_sarana/print_page/invoice',
	...
	function add_row(){
		...
		$this->my_view(['role/sarpras/page/pengembalian_sarana/add_page/row'],$data);
	}
	...
	function process_data($id)
	{
		...
		$this->my_view(['role/sarpras/page/pengembalian_sarana/add_page/proses'],$data);
	}
	function get_detail($id)
	{
		...
		$this->my_view(['role/sarpras/page/pengembalian_sarana/index_page/detail'],$data);
	}
	function get_stats_nav()
	{
		...
		$this->my_view(['role/sarpras/page/pengembalian_sarana/index_page/stats'],$data);
	}
}