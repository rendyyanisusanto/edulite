...
class sarana extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/sarpras/page/sarana/index_page/index','role/sarpras/page/sarana/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/sarpras/page/sarana/add_page/index','role/sarpras/page/sarana/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$data['prasarana']	=	$this->my_where('prasarana', [])->result_array();
				$data['kelompok_sarana']	=	$this->my_where('kelompok_sarana', [])->result_array();
				$this->my_view(['role/sarpras/page/sarana/edit_page/index','role/sarpras/page/sarana/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/sarpras/page/sarana/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/sarpras/page/sarana/print_page/index','role/sarpras/page/sarana/print_page/js'],$data);
