...
class prasarana extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/sarpras/page/prasarana/index_page/index','role/sarpras/page/prasarana/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$this->my_view(['role/sarpras/page/prasarana/add_page/index','role/sarpras/page/prasarana/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$data['kondisi_prasarana']	=	$this->my_where('kondisi_prasarana', [])->result_array();
				$data['kelompok_prasarana']	=	$this->my_where('kelompok_prasarana', [])->result_array();
				$this->my_view(['role/sarpras/page/prasarana/edit_page/index','role/sarpras/page/prasarana/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/sarpras/page/prasarana/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/sarpras/page/prasarana/print_page/index','role/sarpras/page/prasarana/print_page/js'],$data);
