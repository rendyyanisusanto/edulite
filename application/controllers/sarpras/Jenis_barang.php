...
class jenis_barang extends MY_Controller {
	...
	public $arr = [
			'title'				=>	'Halaman jenis_barang',
			'table'				=>	'jenis_barang',
			'column'			=>	[ 'kode_jenis','jenis_barang'],
			'column_order'		=>	[ 'id_jenis_barang','kode_jenis','jenis_barang'],
			'column_search'		=>	[ 'id_jenis_barang','kode_jenis','jenis_barang'],
			'order'				=>	['id_jenis_barang'	=>	'DESC'],
			'id'				=>	'id_jenis_barang'
	];
