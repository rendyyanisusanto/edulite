...
class jadwal_lab extends MY_Controller {
	...
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/sarpras/page/jadwal_lab/index_page/index','role/sarpras/page/jadwal_lab/index_page/js'],$data);
	}
	public function penjadwalan()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/sarpras/page/jadwal_lab/index_page/penjadwalan','role/sarpras/page/jadwal_lab/index_page/js_penjadwalan'],$data);
	}
	function jadwal(){
		...
		$this->my_view(['role/sarpras/page/jadwal_lab/index_page/jadwal'],$data);
	}
	...
	function jadwal_rilis(){
		...
		$this->my_view(['role/sarpras/page/jadwal_lab/index_page/jadwal_rilis'],$data);
	}
	function get_detail(){
		$id = $_POST['id'];
		...
		$this->my_view(['role/sarpras/page/jadwal_lab/index_page/detail_content'],$data);
	}
	public function add_page()
	{
		...
		$this->my_view(['role/sarpras/page/jadwal_lab/add_page/index','role/sarpras/page/jadwal_lab/add_page/js'],$data);
	}
