...
class buku_pemanggilan_siswa extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/kesiswaan/page/buku_pemanggilan_siswa/index_page/index','role/kesiswaan/page/buku_pemanggilan_siswa/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/kesiswaan/page/buku_pemanggilan_siswa/add_page/index','role/kesiswaan/page/buku_pemanggilan_siswa/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/kesiswaan/page/buku_pemanggilan_siswa/edit_page/index','role/kesiswaan/page/buku_pemanggilan_siswa/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
	...
	function hapus()
	{
		...
		foreach ($_POST['data_get'] as $key => $value) {
			$this->db->delete('buku_pemanggilan_siswa',[$dt['id']=>$value]);
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/kesiswaan/page/buku_pemanggilan_siswa/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/kesiswaan/page/buku_pemanggilan_siswa/print_page/index','role/kesiswaan/page/buku_pemanggilan_siswa/print_page/js'],$data);
