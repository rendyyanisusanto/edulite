...
class presensi_harian extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/tu/page/presensi_harian/index_page/index','role/tu/page/presensi_harian/index_page/js'],$data);
	}
	public function rekap()
	{
		...
		$data['mata_pelajaran']		=	$this->my_where('mata_pelajaran', [])->result_array();
		$data['kelas']		=	$this->my_where('kelas', [])->result_array();
		$this->my_view(['role/tu/page/presensi_harian/rekap/index','role/tu/page/presensi_harian/rekap/js'],$data);
	}
	public function proses_presensi_harian($value='')
	{
		...
		$this->my_view(['role/tu/page/presensi_harian/index_page/list_siswa'],$data);
	}
	public function proses_rekap()
	{
		...
		if ($_POST['tipe'] == 0) {
			...
			$this->my_view(['role/tu/page/presensi_harian/rekap/list_siswa'],$data);
		} elseif($_POST['tipe'] == 1){
			foreach ($siswa as $key => $value) {
			...
			$this->my_view(['role/tu/page/presensi_harian/rekap/list_total'],$data);
		}
