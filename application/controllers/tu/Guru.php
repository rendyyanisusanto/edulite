...
class guru extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		// $this->my_view(['role/tu/page/siswa/index','role/tu/page/siswa/js_siswa'],$data);
	...
	public function add_page()
	{
		...
		$this->my_view(['role/tu/page/guru/add_page/index','role/tu/page/guru/add_page/js'],$data);
	}
	...
	public function edit_page()
	{
		...
		if (isset($_POST['send_data'])) {
			...
			$data['param']	=	$this->arr;
			$this->my_view(['role/tu/page/guru/edit_page/index','role/tu/page/guru/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
