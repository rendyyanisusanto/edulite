...
class Ppdb extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/tu/page/ppdb/index_page/index','role/tu/page/ppdb/index_page/js'],$data);
	}
	...
	public function list()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/tu/page/ppdb/index_page/index_list','role/tu/page/ppdb/index_page/js_list'],$data);
	}
	...
	function detail_data($id = "")
	{
		if ($id !== "") {
			...
			$this->my_view(['role/tu/page/ppdb/detail_page/index','role/tu/page/ppdb/detail_page/js'],$data);
		}
	}
	...
	*/
		...
		function cetak_page()
		{
			...
			// $this->my_view(['role/tu/page/guru/print_page/index','role/tu/page/guru/print_page/js'],$data);
