...
class notulensi_rapat extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/tu/page/notulensi_rapat/index_page/index','role/tu/page/notulensi_rapat/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/tu/page/notulensi_rapat/add_page/index','role/tu/page/notulensi_rapat/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/tu/page/notulensi_rapat/edit_page/index','role/tu/page/notulensi_rapat/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/tu/page/notulensi_rapat/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/tu/page/notulensi_rapat/print_page/index','role/tu/page/notulensi_rapat/print_page/js'],$data);
