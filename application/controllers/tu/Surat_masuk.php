...
class surat_masuk extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/tu/page/surat_masuk/index_page/index','role/tu/page/surat_masuk/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/tu/page/surat_masuk/add_page/index','role/tu/page/surat_masuk/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/tu/page/surat_masuk/edit_page/index','role/tu/page/surat_masuk/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/tu/page/surat_masuk/print/print_surat',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/tu/page/surat_masuk/print_page/index','role/tu/page/surat_masuk/print_page/js'],$data);
	...
	*/
	...
	function get_stats_nav()
	{
		...
		$this->my_view(['role/tu/page/surat_masuk/index_page/stats'],$data);
	}
