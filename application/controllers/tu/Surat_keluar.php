...
class surat_keluar extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/tu/page/surat_keluar/index_page/index','role/tu/page/surat_keluar/index_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/tu/page/surat_keluar/edit_page/index','role/tu/page/surat_keluar/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/tu/page/surat_keluar/print/index',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/tu/page/surat_keluar/print_page/index','role/tu/page/surat_keluar/print_page/js'],$data);
