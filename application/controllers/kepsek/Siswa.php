...
class siswa extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/kepsek/page/siswa/index_page/index','role/kepsek/page/siswa/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		...
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/kepsek/page/siswa/add_page/index','role/kepsek/page/siswa/add_page/js'],$data);
	}
	public function perkelas()
	{
		...
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/kepsek/page/siswa/perkelas/index','role/kepsek/page/siswa/perkelas/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$data['jurusan']	=	$this->my_where('jurusan', [])->result_array();
				$data['province']	=	$this->my_where('provinces', [])->result_array();
				$this->my_view(['role/kepsek/page/siswa/edit_page/index','role/kepsek/page/siswa/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	public function detail_all($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/kepsek/page/siswa/detail_page/index','role/kepsek/page/siswa/detail_page/js'],$data);
		} else {
			$this->get_data();
		}
	...
	{
		$data['account']	=	$this->get_user_account();
		$this->my_view(['role/kepsek/page/siswa/upload_page','role/kepsek/page/siswa/js_upload_page'],$data);
	}
	/*
		ADD DATA
	*/
	...
	*/
		...
		function cetak_page($id)
		{
			if (isset($id)) {
				...
				$data['province']	=	$this->my_where('provinces', ['id' => $data['siswa']['idprovince_fk']])->row_array();
				$data['city']		=	$this->my_where('cities', ['id' => $data['siswa']['idcities_fk']])->row_array();
				$this->load->view('role/kepsek/page/siswa/print/print_siswa',$data);
			} else {
				$this->get_data();
			}
		}
	...
	*/
	...
	public function proses_siswa($value='')
	{
		...
		$this->my_view(['role/kepsek/page/siswa/perkelas/proses_siswa','role/kepsek/page/siswa/perkelas/js_proses'],$data);
	}
