...
class presensi_guru extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$this->my_view(['role/kepsek/page/presensi_guru/index_page/index','role/kepsek/page/presensi_guru/index_page/js'],$data);
	}
	...
	function rekap(){
		...
		$this->my_view(['role/kepsek/page/presensi_guru/rekap/index','role/kepsek/page/presensi_guru/rekap/js'],$data);
	}
	public function proses_rekap()
	{
		...
		$data['tahun'] = date('Y');
		$this->my_view(['role/kepsek/page/presensi_guru/rekap/rekap'],$data);
	}
	public function history($id_guru="" ,$bulan="", $tahun=""){
		...
		$this->my_view(['role/kepsek/page/presensi_guru/rekap/history'],$data);
	...
	public function get_presensi()
	{
		...
		$this->my_view(['role/kepsek/page/presensi_guru/index_page/presensi'],$data);
