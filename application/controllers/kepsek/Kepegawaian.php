...
class kepegawaian extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/kepsek/page/kepegawaian/index_page/index','role/kepsek/page/kepegawaian/index_page/js'],$data);
	}
	...
	public function add_page()
	{
		$data['account']	=	$this->get_user_account();
		$data['param'] 		= 	$this->arr;
		$this->my_view(['role/kepsek/page/kepegawaian/add_page/index','role/kepsek/page/kepegawaian/add_page/js'],$data);
	}
	...
	public function edit_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/kepsek/page/kepegawaian/edit_page/index','role/kepsek/page/kepegawaian/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	public function detail_page($id)
	{
		if (isset($id)) {
				...
				$this->my_view(['role/kepsek/page/kepegawaian/detail_page/index','role/kepsek/page/kepegawaian/detail_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		public function print_hari_ini()
		{
				...
				$this->load->view('role/kepsek/page/kepegawaian/print/print_surat',$data);
		}
		function cetak_page()
		{
			$dt = $this->arr;
			...
			$this->my_view(['role/kepsek/page/kepegawaian/print_page/index','role/kepsek/page/kepegawaian/print_page/js'],$data);
