...
class guru extends MY_Controller {
	...
	*/
	public function get_data()
	{
		...
		// $this->my_view(['role/kepsek/page/siswa/index','role/kepsek/page/siswa/js_siswa'],$data);
	...
	public function add_page()
	{
		...
		$this->my_view(['role/kepsek/page/guru/add_page/index','role/kepsek/page/guru/add_page/js'],$data);
	}
	...
	public function edit_page()
	{
		...
		if (isset($_POST['send_data'])) {
			...
			$data['param']	=	$this->arr;
			$this->my_view(['role/kepsek/page/guru/edit_page/index','role/kepsek/page/guru/edit_page/js'],$data);
		} else {
			$this->get_data();
		}
	}
	...
	*/
		...
		function cetak_page()
		{
			...
			// $this->my_view(['role/kepsek/page/guru/print_page/index','role/kepsek/page/guru/print_page/js'],$data);
