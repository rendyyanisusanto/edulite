...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url('include/template/adminlte/plugins')?>/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="<?php echo base_url('include/template/adminlte/plugins')?>/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
