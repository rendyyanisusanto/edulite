...
<div class="row">
	<div class="alert alert-success">
		<marquee>Hallo <b><?php echo $data_get['guru']['nama'] ?></b>, Selamat datang di aplikasi EDULITE milik SMK IT ASY SYADZILI. Hak akses anda saat ini adalah sebagai <b>Hubungan Masyarakat</b></marquee>
	</div>
</div>
<div class="row">
	...
	<div class="panel panel-body bg-blue-400 has-bg-image">
		<div class="media no-margin">
			<div class="media-body">
				<h5 class="no-margin text-semibold pendapatan"><?= $data_get['kerjasama_dudi'] ?></h5>
				<span class="text-uppercase  text-muted">Kerjasama</span>
			</div>
...
<div class="col-sm-6 col-md-3">
	<div class="panel panel-body bg-blue-400 has-bg-image">
		<div class="media no-margin">
			<div class="media-body">
				<h5 class="no-margin text-semibold"><?= $data_get['sosialisasi'] ?></h5>
				<span class="text-uppercase text-size-mini text-muted">Sosialisasi</span>
			</div>
			<div class="media-right media-middle">
...
<div class="col-sm-6 col-md-3">
	<div class="panel panel-body bg-danger-400 has-bg-image">
		<div class="media no-margin">
			<div class="media-body">
				<h5 class="no-margin text-semibold"><?= $data_get['dudi'] ?></h5>
				<span class="text-uppercase text-size-mini text-muted">DU/DI</span>
			</div>
			<div class="media-right media-middle">
...
<div class="col-sm-6 col-md-3">
	<div class="panel panel-body bg-danger-400 has-bg-image">
		<div class="media no-margin">
			<div class="media-body">
				<h5 class="no-margin text-semibold"><?= $data_get['lowongan'] ?></h5>
				<span class="text-uppercase text-size-mini text-muted">Lowongan</span>
			</div>
			<div class="media-right media-middle">
