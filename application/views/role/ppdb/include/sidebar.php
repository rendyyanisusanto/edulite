<ul class="navigation navigation-main navigation-accordion">
  ...
  <li><a href="PPDB/get_data" class="app-item"><i class="icon-users2"></i> <span>Pendaftar Baru</span></a></li>
  <!-- <li><a href="Calon_siswa/get_data" class="app-item"><i class="icon-file-text2"></i> <span>Calon Siswa</span></a></li> -->
