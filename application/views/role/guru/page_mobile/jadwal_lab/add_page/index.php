...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-body">
			...
			<center><h3><b>Peminjaman laboratorium</b></h3></center>
			<fieldset>
	            ...
	            <div class="form-group">
	              <label class="col-lg-3 control-label">Laboratorium:</label>
	              <div class="col-lg-4">
	              	<select name="idlaboratorium_fk" required class="form-control">
	              		<option value="">--Pilih--</option>
	              		<?php foreach ($data_get['laboratorium'] as $key => $value): ?>
