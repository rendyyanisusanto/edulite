<div class="row">
	<div class="col-md-12">
		<div class="panel panel-body">
			<center><h3>Import Data Keseluruhan </h3></center>
			<div class="alert alert-warning">
				Jika anda lebih familiar menggunakan ms excel silahkan <a href="<?php echo base_url('guru/nilai/download_file_all/'.$data_get['kelas']['id_kelas'].'/'.$data_get['mata_pelajaran']['id_mata_pelajaran'].'/'.$data_get['tahun_ajaran']['id_tahun_ajaran']) ?>" target="__blank">download format ini</a>, kemudian lakukan import data pada form dibawah<br>
			...
			<table style ="border: 1px solid black;" class="table table-bordered">
				<thead>
					<tr>
						...
						<th style ="border: 1px solid black;" class="bg-blue" width="2%" rowspan="2">NP</th>
						<th style ="border: 1px solid black;" class="bg-blue" width="2%" rowspan="2">NK</th>
						<th style ="border: 1px solid black;" class="bg-blue" width="2%" rowspan="2">UTS</th>
						<th style ="border: 1px solid black;" class="bg-blue" width="2%" rowspan="2">UAS</th>
					</tr>
				</thead>
				<tbody>
					<?php 
					...
					<?php $rand = rand(0,99999); ?>
						<tr>
							...
							<td><?php echo $value['nilai_pengetahuan'] ?></td>
							<td><?php echo $value['nilai_keterampilan'] ?></td>
							<td><?php echo $value['nilai_pts'] ?></td>
							<td><?php echo $value['nilai_pas'] ?></td>	
						</tr>
					<?php endforeach ?>
				</tbody>
			</table>
