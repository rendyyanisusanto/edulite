...
<div class="row">
	<div class="col-md-5">
		<div class="panel panel-body">
			<form action="Nilai/proses_nilai_harian" id="app-proses" method="POST">
                ...
                <select class="form-control" name="idjenispengetahuan_fk">
                	<?php foreach ($data_get['jenis_nilai'] as $key => $value): ?>
                		<option value="<?php echo $value['id_jenis_pengetahuan'] ?>"><?php echo $value['kode'].' - '.$value['jenis_pengetahuan'] ?></option>
                	<?php endforeach ?>
                </select>
