<div class="row">
	<div class="col-md-12">
		<div class="panel panel-body">
			<form  action="Jurnal_guru/save_jurnal_harian" id="app-jurnal-save" method="POST">
				...
				<?php if (!empty($data_get['jurnal_guru'])){ ?>
					<?php foreach ($data_get['jurnal_guru'] as $key => $value): ?>
						<tr>
							...
							<td><button class="btn btn-xs btn-danger btn-del-jurnal" data-id="<?php echo $value['id_jurnal_guru'] ?>"><i class="icon-trash"></i></button> </td>
						</tr>
					<?php endforeach ?>
