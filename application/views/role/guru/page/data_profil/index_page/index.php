...
<form class="form-horizontal" action="Data_profil/update_data" id="app-submit" method="POST">
  <div class="row">
    <div class="col-md-8">
        ...
        <div class="panel-body">
          ...
          <div class="tab-content">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <?php if (!empty($data_get['guru']['foto'])): ?>
                    <img src="<?php echo base_url('include/media/foto_pegawai/'.$data_get['guru']['foto']) ?>" class="img" style="max-width: 100px;">
                  <?php endif ?>
    ...
    <div class="col-md-4">
      <div class="col-md-12">
        <div class="panel panel-flat">
        <div class="panel-body">
          <button type="submit" class="btn btn-block btn-success legitRipple">Perbarui Profil<i class="icon-floppy-disk position-right"></i></button>
