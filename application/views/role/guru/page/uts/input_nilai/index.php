<div class="row">
	<div class="col-md-12">
		<div class="panel panel-body">
				...
				<tbody>
					...
					<?php $rand = rand(0,99999); ?>
						<tr>
							...
							<td><input type="number" placeholder="Range nilai 0-100" value="<?php echo (isset($value['nilai_pts']))? $value['nilai_pts'] : ''; ?>" name="data[<?php echo $rand ?>][nilai]" class="form-control input-xs"></td>
			...
			<a href="<?php echo $data_get['param']['table'] ?>/get_data" class="btn btn-danger app-item"><i class="icon-circle-left2"></i> Kembali</a>
		</form>
		</div>
	</div>
</div>