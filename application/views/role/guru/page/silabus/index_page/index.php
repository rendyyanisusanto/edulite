...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-body">
			<a href="<?php echo $data_get['param']['table'] ?>/add_page" class="btn app-item bg-teal-400 btn-labeled legitRipple" id="add-btn"><b><i class="icon-pencil4"></i></b> Tambah Silabus</a>
