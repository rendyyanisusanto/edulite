...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-body">
			<center><h3>Catatan siswa kelas <?php echo $data_get['kelas']['kelas'] ?> tanggal <?php echo $data_get['tanggal'] ?></h3></center>
			<div class="col-md-12">
				<div class="panel panel-body">
					<form  action="Akademik/save_catatan_siswa" id="app-catatan-save" method="POST">
						<label >Siswa</label>
						<input type="hidden" value="<?php echo $data_get['mapel_get']['idguru_fk'] ?>" name="idguru_fk">
						<input type="hidden" value="<?php echo $data_get['mapel_get']['idkelas_fk'] ?>" name="idkelas_fk">
						<input type="hidden" value="<?php echo $data_get['mapel_get']['idmapel_fk'] ?>" name="idmapel_fk">
						<input type="hidden" value="<?php echo $data_get['mapel_get']['idgurumapel_fk'] ?>" name="idgurumapel_fk">
						<input type="hidden" value="<?php echo $data_get['tanggal'] ?>" name="tanggal">
						<input type="hidden" value="<?php echo $data_get['mapel_get']['idtahunajaran_fk'] ?>" name="idtahunajaran_fk">
