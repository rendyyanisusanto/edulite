    ...
    <div class="col-md-8">
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h5 class="panel-title">Tambah Data Calon Siswa (<i>Add Data</i>)<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="stacked-icons-biodata">
              ...
              <fieldset>
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="no_register" value="<?php echo (isset($data_get['register']) ? $data_get['register']->values->no_register : "") ?>" class="form-control" required="" placeholder="Input here......">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-lg-3 control-label">Nama:</label>
                  <div class="col-lg-9">
                    <input type="text" name="nama" class="form-control" value="<?php echo (isset($data_get['register']) ? $data_get['register']->values->nama : "") ?>" required="" placeholder="Input here......">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-lg-3 control-label">Tanggal Masuk:</label>
                  <div class="col-lg-6">
                    <input type="date" name="tanggal_masuk" class="form-control" required="" placeholder="Input here......">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-lg-3 control-label">No. HP:</label>
                  <div class="col-lg-6">
                    <input type="text" name="no_hp" class="form-control" value="<?php echo (isset($data_get['register']) ? $data_get['register']->values->no_wa : "") ?>" required="" placeholder="Input here......">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-lg-3 control-label">Status Siswa:</label>
                  <div class="col-lg-4 col-md-6">
                    <select data-placeholder="Pilih status_siswa" name="status_siswa" class="select">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="tempat_lahir" class="form-control" value="<?php echo (isset($data_get['register']) ? $data_get['register']->values->tempat_lahir : "") ?>" placeholder="Input here......">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-lg-3 control-label">Tanggal Lahir:</label>
                  <div class="col-lg-9">
                    <input type="date" name="tanggal_lahir" class="form-control" value="<?php echo (isset($data_get['register']) ? $data_get['register']->values->tanggal_lahir : "") ?>" placeholder="Input here......">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="alamat" class="form-control" value="<?php echo (isset($data_get['register']) ? $data_get['register']->values->alamat : "") ?>" placeholder="Input here......">
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane" id="stacked-icons-ibu">
              <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="nama_ibu" class="form-control" value="<?php echo (isset($data_get['register']) ? $data_get['register']->values->nama_ibu : "") ?>" placeholder="Input here......">
                  </div>
                </div>
            ...
            <div class="tab-pane" id="stacked-icons-ayah">
              <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="nama_ayah" class="form-control" value="<?php echo (isset($data_get['register']) ? $data_get['register']->values->nama_ayah : "") ?>" placeholder="Input here......">
                  </div>
                </div>
