		...
		<div class="panel panel-body">
			...
			<fieldset>
	            ...
	            <div class="form-group">
	              ...
	              <div class="col-lg-9">
	              	<select class="form-control" name="idkategorisuratkeluar_fk">
	              		<?php foreach ($data_get['kategori_surat_keluar'] as $key => $value): ?>
	              			<option value="<?php echo $value['id_kategori_surat_keluar'] ?>"><?php echo $value['kategori_surat_keluar'] ?></option>
	              		<?php endforeach ?>
	              	</select>
	              </div>
	            </div>
	            ...
	            <div class="form-group">
	              <label class="col-lg-3 control-label">Tanggal Deadline:</label>
	              <div class="col-lg-4">
