					...
					<div class="panel panel-body">
						<fieldset>
							<div class="form-group">
			                  ...
			                  <div class="col-lg-8">
			                  	<select data-placeholder="Pilih Tahun Ajaran" required="" name="idtahunajaran_fk" class="select tahun_ajaran">
			                ...
			                <label class="col-lg-4 control-label">Nama Guru</label>
			                  <div class="col-lg-8">
			                    <select data-placeholder="Pilih Kelas" required="" name="idguru_fk" class="select guru">
