  ...
  <div class="col-md-12">
    <div class="panel panel-flat">
      <div class="panel-heading">
        <h6 class="panel-title">Data Online Assesment System<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
      ...
      <div class="panel-body">
        <a href="erapor/add_page" class="btn app-item bg-teal-400 btn-labeled legitRipple"><b><i class="icon-plus3"></i></b> Tambah (<i>add</i>)</a>
