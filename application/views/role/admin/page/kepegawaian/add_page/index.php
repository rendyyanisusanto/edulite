...
<form class="form-horizontal" action="kepegawaian/simpan_data" id="app-submit" method="POST">
  <div class="row">
    <div class="col-md-8">
        ...
        <div class="panel-body">
          ...
          <div class="tab-content">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" name="istri" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" name="email" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" name="no_hp" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">4. Jarak ke Kantor:</label>
              <div class="col-lg-6">
                <input type="text" name="jarak_ke_kantor" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="number" name="bb" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">2. Tinggi Badan:</label>
              <div class="col-lg-6">
                <input type="number" name="tb" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" name="penyakit" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">5. Kelainan yg Dimiliki:</label>
              <div class="col-lg-6">
                <input type="text" name="kelainan" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="number" name="nip" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">&nbsp; 2.2. No. Karpeg:</label>
              <div class="col-lg-6">
                <input type="number" name="no_karpeg" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">&nbsp; 2.2. No. Taspen:</label>
              <div class="col-lg-6">
                <input type="number" name="no_taspen" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="date" name="mulai_bertugas" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">2. Berasal dari:</label>
              <div class="col-lg-6">
                <input type="text" name="berasal_dari" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">3. Meninggalkan Tempat Ini pada Tanggal:</label>
              <div class="col-lg-6">
                <input type="date" name="tanggal_meninggalkan" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">4. Alasan Meninggalkan:</label>
              <div class="col-lg-6">
                <input type="text" name="alasan_meninggalkan" class="form-control"  placeholder="Input here......">
              </div>
            </div>
            </div>
