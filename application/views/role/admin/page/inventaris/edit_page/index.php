        ...
        <div class="panel-body">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <input type="text" name="jml" value="<?php echo $data_get['data_edit']['jml'] ?>" class="form-control" required placeholder="Input here......">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <select data-placeholder="Pilih keadaan" name="keadaan" class="select">
                  <option <?php echo ($data_get['data_edit']['keadaan'] == 'Baik')?'selected':''; ?> value="Baik">Baik</option>
                  <option <?php echo ($data_get['data_edit']['keadaan'] == 'Rusak Ringan')?'selected':''; ?> value="Rusak Ringan">Rusak Ringan</option>
                  <option <?php echo ($data_get['data_edit']['keadaan'] == 'Rusak Berat')?'selected':''; ?> value="Rusak Berat">Rusak Berat</option>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-9">
                 <select data-placeholder="Pilih Jenis Barang" name="idjenisbarang_fk" class="select">
                  <?php foreach ($data_get['jenis_barang'] as $key => $value): ?>
                    <option <?php echo ($data_get['data_edit']['idjenisbarang_fk'] == $value['id_jenis_barang'])?'selected':''; ?> value="<?php echo $value['id_jenis_barang'] ?>"><?php echo $value['jenis_barang'] ?></option>
                  <?php endforeach ?>
                </select>
              </div>
            </div>
              ...
              <div class="col-lg-9">
                 <select data-placeholder="Pilih Ruangan" name="idruangan_fk" class="select">
                  <?php foreach ($data_get['ruangan'] as $key => $value): ?>
                    <option <?php echo ($data_get['data_edit']['idruangan_fk'] == $value['id_ruangan'])?'selected':''; ?> value="<?php echo $value['id_ruangan'] ?>"><?php echo $value['ruangan'] ?></option>
                  <?php endforeach ?>
                </select>
              </div>
            </div>
              ...
              <div class="col-lg-9">
                 <select data-placeholder="Pilih Tahun Ajaran" name="idtahunajaran_fk" class="select">
                  <?php foreach ($data_get['tahun_ajaran'] as $key => $value): ?>
                    <option <?php echo ($data_get['data_edit']['idtahunajaran_fk'] == $value['id_tahun_ajaran'])?'selected':''; ?> value="<?php echo $value['id_tahun_ajaran'] ?>"><?php echo $value['tahun_ajaran'] ?></option>
                  <?php endforeach ?>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <textarea name="keterangan" id="keterangan"><?php echo $data_get['data_edit']['keterangan'] ?></textarea>
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label">Foto:</label>
              <div class="col-lg-9">
                <div class="call-media" data-val="<?php echo $data_get['data_edit']['foto'] ?>">
                </div>
              </div>
            </div>
          </fieldset>
