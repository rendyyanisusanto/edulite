        ...
        <div class="panel-body">
          ...
          <table class="table table-bordered table-xxs">
              <tr>
                ...
                <td><input type="text" class="form-control" name="f_pengirim" placeholder="Tambahkan data pengirim"></td>
              </tr>
              <tr>
                <td width="30%">tanggal_surat</td>
                <td><input type="date" class="form-control" name="f_tanggal_surat"></td>
              </tr>
              <tr>
                <td width="30%">kode_arsip</td>
                <td><input type="text" class="form-control" name="f_kode_arsip" placeholder="Tambahkan data kode arsip"></td>
              </tr>
              <tr>
                <td width="30%">no_surat</td>
